...
export function MyComputerApp() {
  return (
    <ExplorerChrome
      appId="my-computer"
      addressIcon={<ComputerIcon size={14} />}
      addressLabel="My Computer"
      statusText={`${DRIVES.length} objects`}
    >
      <div className="flex flex-col gap-3 p-4 text-[13px] text-neutral-800">
        ...
        <p className="mt-2 text-[11px] text-neutral-400">
          (Cosmetic -- like everything else here it&apos;s telling you the truth: it&apos;s dressing, not a real
          filesystem.)
        </p>
      </div>
    </ExplorerChrome>
